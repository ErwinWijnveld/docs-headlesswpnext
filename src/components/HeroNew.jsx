...
const HomeNew = () => {
  return (
    <div className="relative -mt-20 h-[500px] bg-black">
      <div className="absolute top-0 left-0 right-0 h-screen max-h-[650px]">
        <Image
          src={vercelImg}
          alt="Vercel Logo"
          layout="fill"
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center py-24 px-4 text-center text-white mix-blend-difference">
